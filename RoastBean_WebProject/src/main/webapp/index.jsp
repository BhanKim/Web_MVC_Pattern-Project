    ...
    <section id="gallery" class="gallery">
      <div class="container-fluid">
        ...
        <div class="section-title">
          <h2>Some photos from <span>Our Coffee Community</span></h2>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/indeximg/kswprofile.png" class="testimonial-img" alt="">
                <h3>Sangwon Kim</h3>
                <h4>Login &amp; Sign up &amp; Mypage &amp; Design &amp; Customer Service</h4>
                <div class="stars">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h3>Younghyuk Kim</h3>
                <h4>Coummunity Board &amp; Mainpage &amp; Information &amp; Location</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/indeximg/jyhprofile.png" class="testimonial-img" alt="">
                <h3>Yunhyun Jung</h3>
                <h4>Producitlist &amp; Cart &amp; ProductDetail &amp; Order</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
