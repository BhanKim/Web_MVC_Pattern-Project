...
<body>
	...
	<main id="main">
		...
		<div class="container text-center">
			...
			<div align="center"><img alt="" src="assets/img/logo.png"></div>
			...
			<div class="row align-items-center">
				...
				<div class="col align-items-center">
					<div class="col"
						...
						<div class="mb-3">
							<a tabindex="-1" style="color: #5464F9;">Forgot password?</a>
						</div>
						<div class="mb-3">
							<div>
								No account? <a tabindex="-1" style="color: #5464F9;">Create
									one</a>
							</div>
						</div>
					</div>
