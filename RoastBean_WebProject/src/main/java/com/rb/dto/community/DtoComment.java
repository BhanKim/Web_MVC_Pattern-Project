...
public class DtoComment {
	...
	Timestamp community_comment_codate;
	...
	public DtoComment(int community_comment_cono, int community_comment_id, String community_comment_name,
			String community_comment_content, Timestamp community_comment_codate) {
		super();
	...
	public Timestamp getCommunity_comment_codate() {
		return community_comment_codate;
	}


	public void setCommunity_comment_codate(Timestamp community_comment_codate) {
		this.community_comment_codate = community_comment_codate;
	}
