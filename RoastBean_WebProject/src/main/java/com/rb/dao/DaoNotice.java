...
public class DaoNotice {
	...
	public ArrayList<DtoNotice> noticeList(){
		...
		try {
			...
			String query = "select @rownum := @rownum + 1 rownumber, notice_write_seq, notice_write_title, notice_write_content, notice_write_initdate, notice_write_updatedate "
...
//				int notice_write_seq = resultSet.getInt("notice_write_seq");
				...
				DtoNotice dto = new DtoNotice(rownumber, notice_write_seq, notice_write_title, notice_write_content, notice_write_initdate, notice_write_updatedate);
				dtos.add(dto);
			}
